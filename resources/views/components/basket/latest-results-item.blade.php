<x-ui.card class="text-center {{ $class ?? '' }}">
    <a href="#" class="block">
        <div
            class="p-2 -mx-6 -mt-6 mb-4 text-sm text-white bg-gradient-to-br rounded-t-lg from-secondary/95 to-secondary/70">
        ...
        <div class="flex justify-between items-center mb-6">
            <div class="flex-1 team">
                <figure
                    class="flex overflow-hidden justify-center items-center mx-auto mb-2 w-12 h-12 bg-gray-100 rounded-full">
            ...
            <div class="flex-1 team">
                <figure
                    class="flex overflow-hidden justify-center items-center mx-auto mb-2 w-12 h-12 bg-white rounded-full">
                    {{-- <svg class="w-8 h-8 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path d="M12 8c-1.657 0-3 1.343-3 3s1.343 3 3 3 3-1.343 3-3-1.343-3-3-3z" />
                    </svg> --}}
