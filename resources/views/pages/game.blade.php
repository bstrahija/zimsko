            ...
            <div class="md:col-span-12 lg:col-span-8">
                ...
                @else
                    ...
                    @if ($game->scheduled_at->year >= 2025)
                        ...
                        @else
                            <x-games.compare-teams :game="$game" :live="$live" :homeWins="$homeWins"
                                :awayWins="$awayWins" />

                            <x-games.team-games-between :game="$game" :live="$live" :games="$gamesBetween" />

                            <x-games.team-latest-games :game="$game" :live="$live" :homeGames="$homeGames"
                                :awayGames="$awayGames" />
                        @endif
                    @else
