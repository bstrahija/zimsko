    ...
    @if ($game)
        <div class="relative pt-6 pb-11 mb-12 bg-center bg-no-repeat bg-cover bg-gradient-to-br rounded-sm rounded-t shadow-sm live-score-widget from-secondary/95 to-secondary/70"
            ...
            <div class="grid grid-cols-2 gap-8 mb-8 w-full lg:gap-10 text-white/90">
                <div class="flex overflow-hidden flex-col gap-6 justify-between items-center w-full bg-white/90">
                    <div class="flex flex-col items-center pt-4">
                        <p class="px-2 py-2 text-center team-logo">
                            <img src="{{ $game->homeTeam->logo() }}" alt="" class="rounded-full size-10">
                        </p>
                        <h2 class="px-4 py-2 text-lg font-bold text-center drop-shadow md:text-3xl text-black/80 font-heading">
                            {{ $game->homeTeam->title }}
                        </h2>
                    </div>
                    <p
                        class="flex justify-center items-center px-4 py-4 w-full h-full font-mono text-xl font-extrabold text-center border-t-4 drop-shadow-xl md:text-4xl bg-primary/80 border-primary">
                        {{ $game->home_score }}
                    </p>
                </div>
            ...
            <div class="grid grid-cols-2 gap-8 px-8 mx-auto max-w-xl md:gap-8 lg:gap-10 md:grid-cols-4">
