...
class SyncRounds
{
    public static function run()
    {
        ...
        foreach ($events as $event) {
            ...
            if (! Round::where('event_id', $event->id)->where('slug', $event->slug . '-za-9-mjesto')->exists())  Round::query()->create(['event_id' => $event->id, 'title' => 'Za 9. mjesto', 'slug' => $event->slug . '-za-9-mjesto',  'type' => 'placing',     'status' => 'completed', 'subtype' => '9th']);
            if (! Round::where('event_id', $event->id)->where('slug', $event->slug . '-za-7-mjesto')->exists())  Round::query()->create(['event_id' => $event->id, 'title' => 'Za 7. mjesto', 'slug' => $event->slug . '-za-7-mjesto',  'type' => 'placing',     'status' => 'completed', 'subtype' => '7th']);
            if (! Round::where('event_id', $event->id)->where('slug', $event->slug . '-za-5-mjesto')->exists())  Round::query()->create(['event_id' => $event->id, 'title' => 'Za 5. mjesto', 'slug' => $event->slug . '-za-5-mjesto',  'type' => 'placing',     'status' => 'completed', 'subtype' => '5th']);
            if (! Round::where('event_id', $event->id)->where('slug', $event->slug . '-za-3-mjesto')->exists())  Round::query()->create(['event_id' => $event->id, 'title' => 'Za 3. mjesto', 'slug' => $event->slug . '-za-3-mjesto',  'type' => 'placing',     'status' => 'completed', 'subtype' => '3rd']);
